...
## 5.1.5 - 2026-06-24
Number of cache clusters for provisioned instances now defaults to 2 when automaticFailoverEnabled or multiAzEnabled is true.

## 5.1.4 - 2026-06-24
Number of cache clusters for provisioned instances is now configurable and defaults to 1.

## 5.1.3 - 2026-06-24
Unnecessary log groups creation removed

## 5.1.2 - 2026-06-24
Possibility to ignore stack-to-lambda connectivity errors during deployment

## 5.1.1 - 2026-06-23
Serverless or provisioned cache (mutually exclusive)
...
## 5.0.8 - 2026-05-31
Old redis-style default user removed

## 5.0.7 - 2026-05-31
Serverless cache usernames normalization

## 5.0.6 - 2026-05-31
Serverless cache case corrected for CDK deploys
...
```ts
import { TSApiConstruct } from "typizator-handler/cdk";
```

## 4.10.2 - 2026-05-29
Provisioned instances additional setup settings

## 4.10.1 - 2026-05-29
AWS CDK lib constructs moved to peer dependencies

## 4.10.0 - 2026-05-27
Provisioned instances support added for lambdas

## 4.9.0 - 2026-05-27
Valkey / Redis cache support added
...
## 4.8.0 - 2026-03-19
TS callbacks for migration lists
